...
Database.then(async(db)=>{
    ...
    // o horario que a pessoa trabalha, das 8 as 18
    // o horario do time from precisa ser menor ou igual o solicitado
    //o time to precisa estar acima
